...
export default class ProductCategory extends MyBaseModel {
  static entity = 'productcategory';
  static entityUrl = '/api/product-categories';
  static primaryKey = 'id';
  static titleKey = 'id';
  static entityHumanName = 'ProductCategory';
